...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanAddBasketItem()
        {
            ...
            //basketService.AddToBasket(hhtpContext, "1");
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "lisettephilibert@hotmail.com" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("lisettephilibert@hotmail", "Forms"), null);
